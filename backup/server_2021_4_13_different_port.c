...
void UDP_Function(void *args, double comp_time){
    ...
    /* recv ms measure */
    int32_t comps_sec = (int32_t)(comp_time / 1000);
    int32_t comps_nsec = (int32_t)((comp_time - (int64_t)(comp_time / 1000) * 1000) * 1000000);
...
void *UDP_FC_COMPS_Thread(void *arg){
    ...
    int64_t *fc_comps_buf=(int64_t *)malloc(sizeof(int64_t) * 30);
